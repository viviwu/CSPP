...
- (void)fullScreenButtonClickedHandlerForPlayController:(UIViewController *)playController
    ...
    if ([playController isKindOfClass:[CSVodPlayController class]]) {
        CSVodPlayController *vpc = (CSVodPlayController *)playController;
...
- (void)fullScreenButtonClickedHandlerForCSVodPlayController:(CSVodPlayController *)vodPlayController isFullScreen:(BOOL)isFullScreen
{
    ...
    [[UIDevice currentDevice] setValue:@(orientation) forKey:@"orientation"];
    if ([vodPlayController isKindOfClass:[CSVodPlayController class]]) {
        CSVodPlayController *vpc = (CSVodPlayController *)vodPlayController;
...
- (void)fullScreenHandlerForLivePlayController:(CSLivePlayViewController *)playController
    ...
    [[UIDevice currentDevice] setValue:@(orientation) forKey:@"orientation"];
    if ([playController isKindOfClass:[CSLivePlayViewController class]]) {
        CSLivePlayViewController *vpc = (CSLivePlayViewController *)playController;
        vpc.fullScreen = (orientation != UIInterfaceOrientationPortrait);
    }
}
