...
- (void)configeWithVideoModel:(VideoModel *)videoModel {
    ...
    NSLog(@"CoverURL = %@", videoModel.CoverURL.lastObject);
    self.descriptionLab.text = videoModel.VideoTitle;
    //找到背景图片设置为空的地方
    [self.coverImageView sd_setImageWithURL:[NSURL URLWithString:videoModel.CoverURL.lastObject] placeholderImage:[UIImage imageNamed:@"goldengate"]];
}
