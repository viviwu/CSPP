...
{
    UITableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:@"faq" forIndexPath:indexPath];
...
{
//    _segmentView.selectedSegmentIndex=section;
    if (0==section) {
        return _segmentView;
    }
    return nil;
...
- (nonnull __kindof UICollectionViewCell *)collectionView:(nonnull UICollectionView *)collectionView cellForItemAtIndexPath:(nonnull NSIndexPath *)indexPath {
    ...
    UICollectionViewCell * cell =[collectionView dequeueReusableCellWithReuseIdentifier:@"expert" forIndexPath:indexPath];
